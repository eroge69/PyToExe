...
x87 = 0.0015
y87 = $bar/5
z87 = $off_x+($size_x/10)*1
ps-t100 = ResourceSliderUIOn
run = CustomShaderSliderMenu
z87 = $off_x+($size_x/10)*2
ps-t100 = ResourceSliderUIOn
run = CustomShaderSliderMenu
z87 = $off_x+($size_x/10)*3
ps-t100 = ResourceSliderUIOn
run = CustomShaderSliderMenu
z87 = $off_x+($size_x/10)*4
ps-t100 = ResourceSliderUIOn
run = CustomShaderSliderMenu
z87 = $off_x+($size_x/10)*5
ps-t100 = ResourceSliderUIOn
run = CustomShaderSliderMenu
z87 = $off_x+($size_x/10)*6
ps-t100 = ResourceSliderUIOn
run = CustomShaderSliderMenu
z87 = $off_x+($size_x/10)*7
ps-t100 = ResourceSliderUIOn
run = CustomShaderSliderMenu
z87 = $off_x+($size_x/10)*8
ps-t100 = ResourceSliderUIOn
run = CustomShaderSliderMenu
z87 = $off_x+($size_x/10)*9
ps-t100 = ResourceSliderUIOn
run = CustomShaderSliderMenu
