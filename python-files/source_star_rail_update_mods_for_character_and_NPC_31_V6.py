...
old_vs_new = {
    ...
    "93f9c6fc":"7c08b8a8",
    "506edd10":"49dbc0a2",
    "637ad2db":"49dbc0a2", #fix wrong hash in V2
    # Guinaifenhair
    "1b4cc6bb":"02f9db09",
    "7e75c06e":"9184be3a",
    # Guinaifenface
    ...
    "3d12735a":"94b37144",
    "da48c709":"44e14830",
    "6205432d":"3af9021d", #fix wrong hash in V3
    "27bf8ebf":"f1751019", #fix wrong hash in V3
    "7abd2d8f":"7da1cd27", #fix wrong hash in V3
    "b10b2e91":"94b37144", #fix wrong hash in V3
    "a23ddb70":"44e14830", #fix wrong hash in V3
    # AmphoreusNPC2-3
    "4054a3fe":"7549a8b8",
    "960e77ad":"2f74813a",
    "2c263e6c":"ed4c8417",
    "46f3ff5f":"7f862c3d",
    "938a531f":"7f862c3d", #fix wrong hash in V3
    "b2206637":"2c760e0b",
    # AmphoreusNPC3-1
    "c71aa0e9":"deafbd5b",
    "0d459ac9":"e2b4e49d",
...
replacement_mapping = {
    # sora
    "VertexLimitRaise]\nhash = 49dbc0a2": {
        "VertexLimitRaise]\nhash = 49dbc0a2":"VertexLimitRaise]\nhash = 637ad2db",
    },
}
