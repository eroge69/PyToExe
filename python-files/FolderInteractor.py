...
def data_analyzer():
    # Benutzeraufforderung für den Pfad
    ...
    def list_files(startpath):
        ...
        for root, dirs, files in os.walk(startpath):
            for name in files:
                ...
                # Informationen über die Datei sammeln
                file_size_bytes = os.path.getsize(file_path)  # Größe in Bytes
                file_size_mbytes = file_size_bytes / (1024 * 1024)  # Größe in Megabytes
                modification_time = os.path.getmtime(file_path)  # Zeitstempel der letzten Änderung
                ...
                # Hinzufügen der Informationen zur Liste
    ...
    if os.path.exists(path):
        ...
        # Benutzeraufforderung für den Speicherort der Excel-Datei
        excel_path = input("Geben Sie den Pfad zum Speichern der Excel-Datei ein (z.B. C:\\Pfad\\Dateiliste.xlsx): ")

        # Überprüfen, ob der Pfad die Endung .xlsx hat
...
def folder_creator():
    ...
    # Überprüfen, ob der Zielpfad bereits existiert
