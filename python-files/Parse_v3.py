...
for json_file in json_files:
    ...
    for j, entry in enumerate(data_3):
        ...
        for i, dpd in enumerate(split_dpd(payment_history)):
            reference_date = payment_start_date - timedelta(days=30 * i)  # Using timedelta instead of relativedelta
    ...
    L12M_reportings = [entry for entry in monthly_reportings_data if entry["Reference_Date"] >= (date_processed - timedelta(days=365))]  # Using timedelta
