...
class FileAnimation:
    ...
    def generate_file_list(self):
        system_files = [
            "kernel32.dll", "ntoskrnl.exe", "hal.dll", 
            "win32k.sys", "explorer.exe", "svchost.exe",
            "csrss.exe", "smss.exe", "system32.dll",
            "user32.dll", "gdi32.dll", "advapi32.dll",
            "ntdll.dll", "shell32.dll", "msvcrt.dll",
            "comctl32.dll", "atapi.sys", "tcpip.sys",
            "disk.sys", "SYSTEM", "SOFTWARE",
            "SECURITY", "bootmgr", "winload.exe",
            "winresume.exe", "pagefile.sys", "registry",
            "SAM", "DEFAULT", "DRIVERS", "install.rett.exe",
            ''
        ]
