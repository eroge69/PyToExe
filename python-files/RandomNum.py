...
class RandomPickerApp:
    def __init__(self, root):
        ...
        # 主数字显示
        self.number_label = tk.Label(root, text="准备开始", font=("Arial", 100), bg="white", fg="black", anchor="center", justify="center")
    ...
    def restart(self):
        ...
        self.font_size_entry.insert(0, "100")
        self.number_label.config(text="准备开始", font=("Arial", 100), bg="white", fg="black")
