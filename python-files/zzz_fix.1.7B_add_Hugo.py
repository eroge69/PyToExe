# 1.6 Hashes updates by HammyCatte
...
def main():
    parser = argparse.ArgumentParser(
        prog="ZZZ Fix 1.6 by HammyCatte",
        description=('')
    )
...
hash_commands = {
    ...
    '43a4d256': [
        ...
        (add_section_if_missing,        ('02d8a2cb', 'AstraSkin.Body.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('6da1b76a', '6989dc5a'), 'AstraSkin.BodyA.MaterialMap.1024')),
    ],
    '8212713f': [
    ...
    '6da1b76a': [
        ...
        (add_section_if_missing,        ('02d8a2cb', 'AstraSkin.Body.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('43a4d256', '56abc3a3'), 'AstraSkin.BodyA.MaterialMap.2048')),
    ],
    ...
    'ce3e73be': [
        ...
        (add_section_if_missing,        ('217ec790', 'Soldier0.Hair.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   ('464847b3', 'Soldier0.HairA.MaterialMap.2048')),
    ],
