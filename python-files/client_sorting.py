...
# Attempting to import, if fail, install the package
try:
    import pandas as pd
except ImportError:
    install("pandas")
...
try:
    ...
    # 'tkinter' is part of the standard library and shouldn't need installing
    print("Tkinter is a standard library; ensure your Python installation includes it.")
