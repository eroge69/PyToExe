...
cwd = os.getcwd()
VERSION = "1.1.0"
GITHUB_URL = "https://raw.githubusercontent.com/RizynGG/happymeal/refs/heads/main/reviews.json"
...
def download_reviews_from_github():
    ...
    url = "https://raw.githubusercontent.com/RizynGG/happymeal/refs/heads/main/reviews.json"
    response = requests.get(url, timeout=10)
