...
def fix_vibration():
    try:
        ...
        messagebox.showinfo("موفقیت", "درایورها و سرویس‌ها با موفقیت نصب شدند.\nلطفاً کنترلر را دوباره وصل کنید.")
        
    except Exception as e:
        messagebox.showerror("خطا", f"خطای ناشناخته:\n{e}")
...
if __name__ == "__main__":
    if not is_admin():
        if messagebox.askyesno("خطای دسترسی", "این برنامه نیاز به اجرا با حقوق مدیر دارد. آیا می‌خواهید دوباره اجرا شود؟"):
            run_as_admin()
        sys.exit(1)
    create_gui()