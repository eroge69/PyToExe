...
# Рамка с системными файлами в правом нижнем углу
file_frame = tk.Frame(
    root,
    bg='gray',
    bd=2,
...
# Запускаем таймер и анимацию файлов
update_timer()
update_system_files()
