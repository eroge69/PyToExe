...
s0,s1,s2,s3,s4,s5,s6,s7,s8,s9,s10,s11,s12,s13,s14,s15,s16,s17,s18,s19,s20,s21,s22,s23=True,True,True,True,False,True,True,False,True,False,True,True,False,False,True,False,False,True,False,True,True,True,True,True
loc4=""
loc7=""
def sho():
...
def ent9():
	...
	if d!=0:	
		...
		pla2 = Label( fr11,text="Please select at least one class day." ,font=("Calibri",15),justify="left")
		pla2.pack(side=LEFT)
		s11=True
	fr11.place(x=50,y=535)
	if s12==True:
		pla3.config(text = "")		
	if e < len(snag) and d!=0:			
	...
	pbu3.pack(side=LEFT)
	fr12.place(x=400,y=585)							
	s12=True			
def ent10():
	global e,s11,s13,tna,loc7,p,snag,co,cox,al,alg,f,g,h,k,s13,s23,pla4	
	fr11=Frame()
	s=len(alg)
	if e!=len(snag):
		pla2 = Label( fr11,text="You have not finished inserting frequency per week of subjects. \n                     Please start again. " ,font=("Calibri",15),justify="left")
		pla2.pack(side=LEFT);
		fr11.place(x=600,y=585)
		s23=False
	if s13==True and p != s:		
		n=v.get()
		co.append(n)
