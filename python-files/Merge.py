...
def main():
    ...
    parser.add_argument("-b", "--back", type=str, help="Key to press to cycle mods in reverse")
    ...
    if args.back:
        ...
        print("\nPlease enter the key that will be used to cycle mods in reverse (can also enter this with -k flag, or set later in .ini). Key must be a single letter\n")
        back = input()
