...
hash_commands = {
    ...
    '057f3c55': [
        ...
        (add_section_if_missing,        ('5c0240db', 'Anby.Hair.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('9ceea795', '476ab69c'), 'Anby.HairA.LightMap.1024')),
    ],
    '476ab69c': [
        (log,                           ('2.0: Anby HairA LightMap 1024p Hash',)),
        (add_section_if_missing,        ('5c0240db', 'Anby.Hair.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('b54f2a3d', '057f3c55'), 'Anby.HairA.LightMap.2048')),
    ],
    '20890a00': [
    ...
    '59b123c2': [
        ...
        (add_section_if_missing,        ('4816de84', 'Anby.Body.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('9cddbf1e', '9b57e140'), 'Anby.BodyA.LightMap.1024')),
    ],
    '9b57e140': [
        (log,                           ('2.0: Anby BodyA LightMap 1024p Hash',)),
        (add_section_if_missing,        ('4816de84', 'Anby.Body.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('7c24acc9', '59b123c2'), 'Anby.BodyA.LightMap.2048')),
    ],
    'ccca3b8e': [
    ...
    '41601dfa': [
        ...
        (add_section_if_missing,        ('6b95c80d', 'Anton.Hair.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('21ee9a3f', 'f6e280b0'), 'Anton.HairA.LightMap.1024')),
    ],
    'f6e280b0': [
        (log,                           ('2.0: Anton HairA LightMap 1024p Hash',)),
        (add_section_if_missing,        ('6b95c80d', 'Anton.Hair.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('ee06579e', '41601dfa'), 'Anton.HairA.LightMap.2048')),
    ],
    'd47c5823': [
        (log,                           ('2.0: Anton HairA MaterialMap 2048p Hash',)),
        (add_section_if_missing,        ('6b95c80d', 'Anton.Hair.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('6fc654e1', '05bd454d'), 'Anton.HairA.MaterialMap.1024')),
    ],
    '05bd454d': [
        (log,                           ('2.0: Anton HairA MaterialMap 1024p Hash',)),
        (add_section_if_missing,        ('6b95c80d', 'Anton.Hair.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('24caeb1f', 'd47c5823'), 'Anton.HairA.MaterialMap.2048')),
    ],
    'b216f758': [
    ...
    'ed6f4199': [
        ...
        (add_section_if_missing,        ('653fb27c', 'Anton.Body.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('8e5ba7d0', 'a937bcee'), 'Anton.BodyA.LightMap.1024')),
    ],
    'a937bcee': [
        (log,                           ('2.0: Anton BodyA LightMap 1024p Hash',)),
        (add_section_if_missing,        ('653fb27c', 'Anton.Body.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('17cf1b74', 'ed6f4199'), 'Anton.BodyA.LightMap.2048')),
    ],
    '986c9716': [
        (log,                           ('2.0: Anton BodyA MaterialMap 2048p Hash',)),
        (add_section_if_missing,        ('653fb27c', 'Anton.Body.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('b7ce5f0b', 'bb25e0f0'), 'Anton.BodyA.MaterialMap.1024')),
    ],
    'bb25e0f0': [
        (log,                           ('2.0: Anton BodyA MaterialMap 1024p Hash',)),
        (add_section_if_missing,        ('653fb27c', 'Anton.Body.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('0238b0ff', '986c9716'), 'Anton.BodyA.MaterialMap.2048')),
    ],
    '1b4ad5b7': [
    ...
    'ef7880e3': [
        ...
        (add_section_if_missing,        ('a21fcee4', 'Anton.Jacket.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('c42628a5', 'edb33cec'), 'Anton.JacketA.LightMap.1024')),
    ],
    'edb33cec': [
        (log,                           ('2.0: Anton JacketA LightMap 1024p Hash',)),
        (add_section_if_missing,        ('a21fcee4', 'Anton.Jacket.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('886a664a', 'ef7880e3'), 'Anton.JacketA.LightMap.2048')),
    ],
    'd36a2f7a': [
    ...
    '7ce9f1db': [
        ...
        (add_section_if_missing,        ('02d8a2cb', 'AstraSkin.Body.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   ('83ede428', 'AstraSkin.BodyA.LightMap.1024')),
    ],
    '83ede428': [
        (log,                           ('1.5: AstraSkin BodyA LightMap 1024p Hash',)),
        (add_section_if_missing,        ('02d8a2cb', 'AstraSkin.Body.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   ('7ce9f1db', 'AstraSkin.BodyA.LightMap.2048')),
    ],
    '43a4d256': [
        (log,                           ('1.6: AstraSkin BodyA MaterialMap 2048p Hash',)),
        (add_section_if_missing,        ('02d8a2cb', 'AstraSkin.Body.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('6989dc5a', '6da1b76a'), 'AstraSkin.BodyA.MaterialMap.1024')),
    ],
    '6da1b76a': [
        (log,                           ('1.6: AstraSkin BodyA MaterialMap 1024p Hash',)),
        (add_section_if_missing,        ('02d8a2cb', 'AstraSkin.Body.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('56abc3a3', '43a4d256'), 'AstraSkin.BodyA.MaterialMap.2048')),
    ],
    ...
    '7d562f53': [
        ...
        (add_section_if_missing,        ('bea4a483', 'Belle.Hair.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('2e656f2f', 'f44f330b'), 'Belle.HairA.LightMap.1024')),
    ],
    'f44f330b': [
        (log,                           ('2.0: Belle HairA LightMap 1024p Hash',)),
        (add_section_if_missing,        ('bea4a483', 'Belle.Hair.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('f1ee2105', '7d562f53'), 'Belle.HairA.LightMap.2048')),
    ],
    '34bdb036': [
    ...
    '2fa5ffa7': [
        ...
        (add_section_if_missing,        ('9c4f1a9a', 'Ben.Hair.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('1439d2b9', '9372e123'), 'Ben.HairA.LightMap.1024')),
    ],
    '9372e123': [
        (log,                           ('2.0: Ben HairA LightMap 1024p Hash',)),
        (add_section_if_missing,        ('9c4f1a9a', 'Ben.Hair.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('cc195dc5', '2fa5ffa7'), 'Ben.HairA.LightMap.2048')),
    ],
    '12e5120e': [
        (log,                           ('2.0: Ben HairA MaterialMap 2048p Hash',)),
        (add_section_if_missing,        ('9c4f1a9a', 'Ben.Hair.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('d665246d', 'dd8c0b3a'), 'Ben.HairA.MaterialMap.1024')),
    ],
    'dd8c0b3a': [
    ...
    'd27a8f6b': [
        ...
        (add_section_if_missing,        ('94288cca', 'Ben.Body.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('6a80c2d8', '9a724295'), 'Ben.BodyA.LightMap.1024')),
    ],
    '9a724295': [
        (log,                           ('2.0: Ben BodyA LightMap 1024p Hash',)),
        (add_section_if_missing,        ('94288cca', 'Ben.Body.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('cb84ed5e', 'd27a8f6b'), 'Ben.BodyA.LightMap.2048')),
    ],
    '2edd6f62': [
        (log,                           ('2.0: Ben BodyA MaterialMap 2048p Hash',)),
        (add_section_if_missing,        ('94288cca', 'Ben.Body.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('decc28c5','3678fad4'), 'Ben.BodyA.MaterialMap.1024')),
    ],
    '3678fad4': [
        (log,                           ('2.0: Ben BodyA MaterialMap 1024p Hash',)),
        (add_section_if_missing,        ('94288cca', 'Ben.Body.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('3f4f6bc0', '2edd6f62'), 'Ben.BodyA.MaterialMap.2048')),
    ],
    '1b79fa5c': [
    ...
    'cf4769ce': [
        ...
        (add_section_if_missing,        ('dc7978f3', 'Billy.Face.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('877e1a0d', 'f5a507da'), 'Billy.FaceA.LightMap.1024')),
    ],
    'f5a507da': [
        (log,                           ('2.0: Billy FaceA LightMap 1024p Hash',)),
        (add_section_if_missing,        ('dc7978f3', 'Billy.Face.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('9f02ef2b', 'cf4769ce'), 'Billy.FaceA.LightMap.2048')),
    ],
    '3a7d88a1': [
        (log,                           ('2.0: Billy FaceA MaterialMap 2048p Hash',)),
        (add_section_if_missing,        ('dc7978f3', 'Billy.Face.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('dc2f2dd2', 'e534abc0'), 'Billy.FaceA.MaterialMap.1024')),
    ],
    'e534abc0': [
        (log,                           ('2.0: Billy FaceA MaterialMap 1024p Hash',)),
        (add_section_if_missing,        ('dc7978f3', 'Billy.Face.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('d166c3e5', '3a7d88a1'), 'Billy.FaceA.MaterialMap.2048')),
    ],
    'e5f2fc35': [
    ...
    '6a6a1c79': [
        ...
        (add_section_if_missing,        ('21e98aeb', 'Billy.Hair.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('0475db07', 'ff939fb7'), 'Billy.HairA.Diffuse.2048')),
    ],
    'b6e1da4b': [
        (log,                           ('2.0: Billy HairA LightMap 2048p Hash',)),
        (add_section_if_missing,        ('21e98aeb', 'Billy.Hair.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('d269a0a1', 'f6749665', '2edbc842'), 'Billy.HairA.LightMap.1024')),
    ],
    '2edbc842': [
        (log,                           ('2.0: Billy HairA LightMap 1024p Hash',)),
        (add_section_if_missing,        ('21e98aeb', 'Billy.Hair.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('4817b1bc', 'b6e1da4b'), 'Billy.HairA.LightMap.2048')),
    ],
    '47bbe297': [
    ...
    '6305a7f4': [
        ...
        (add_section_if_missing,        ('3371580a', 'Billy.Body.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('0d5d374f', 'adc2ec7c'), 'Billy.BodyA.LightMap.1024')),
    ],
    'adc2ec7c': [
        (log,                           ('2.0: Billy BodyA LightMap 1024p Hash',)),
        (add_section_if_missing,        ('3371580a', 'Billy.Body.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('789b054e', '6305a7f4'), 'Billy.BodyA.LightMap.2048')),
    ],
    '9cb20fa9': [
    ...
    'd5d3585b': [
        ...
        (add_section_if_missing,        ('7a8fa826', 'Caesar.Hair.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('c7115c4b', '89b2d3b3'), 'Caesar.HairA.LightMap.1024')),
    ],
    '89b2d3b3': [
        (log,                           ('2.0: Caesar HairA LightMap 1024p Hash',)),
        (add_section_if_missing,        ('7a8fa826', 'Caesar.Hair.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('bf19954f', 'd5d3585b'), 'Caesar.HairA.LightMap.2048')),
    ],
    '350b827e': [
    ...
    '74d66671': [
        ...
        (add_section_if_missing,        ('5a839fb2', 'Corin.Hair.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('edff2372', '0f300531'), 'Corin.HairA.LightMap.1024')),
    ],
    '0f300531': [
        (log,                           ('2.0: Corin HairA LightMap 1024p Hash',)),
        (add_section_if_missing,        ('5a839fb2', 'Corin.Hair.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('929aca42', '74d66671'), 'Corin.HairA.LightMap.2048')),
    ],
    # '23b4c60d': [
    ...
    'e1c1718f': [
        ...
        (multiply_section_if_missing,   (('af7eda82', '068be251'), 'Corin.BodyA.LightMap.1024')),
    ],
    '068be251': [
        (log,                           ('2.0: Corin BodyA, BearA LightMap 1024p Hash',)),
        (multiply_section_if_missing,   (('75e05cdc', 'e1c1718f'), 'Corin.BodyA.LightMap.2048')),
    ],
    'e58d9767': [
        (log,                           ('2.0: Corin BodyA, BearA MaterialMap 2048p Hash',)),
        (multiply_section_if_missing,   (('9dc9c0f6', '50ed6c50'), 'Corin.BodyA.MaterialMap.1024')),
    ],
    '50ed6c50': [
        (log,                           ('2.0: Corin BodyA, BearA MaterialMap 1024p Hash',)),
        (multiply_section_if_missing,   (('50a0faea', 'e58d9767'), 'Corin.BodyA.MaterialMap.2048')),
    ],
    '289f4c58': [
    ...
    '8740602f': [
        ...
        (add_section_if_missing,        ('f601f643', 'EllenSkin.Hair.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('0cf3cd79', '0ab940d8'), 'EllenSkin.HairA.MaterialMap.1024')),
    ],
    '0ab940d8': [
        (log,                           ('2.0: EllenSkin HairA MaterialMap 1024p Hash',)),
        (add_section_if_missing,        ('f601f643', 'EllenSkin.Hair.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('0de025b4', '8740602f'), 'EllenSkin.HairA.MaterialMap.2048')),
    ],
    ...
    '1d7b458d': [
        ...
        (add_section_if_missing,        ('4a938c0a', 'EllenSkin.Body.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('a4b66af3', 'ae919d9f'), 'EllenSkin.BodyA.MaterialMap.1024')),
    ],
    'ae919d9f': [
        (log,                           ('2.0: EllenSkin BodyA MaterialMap 1024p Hash',)),
        (add_section_if_missing,        ('4a938c0a', 'EllenSkin.Body.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('d08f1a54', '1d7b458d'), 'EllenSkin.BodyA.MaterialMap.2048')),
    ],
    ...
    '51cc39d5': [
        ...
        (add_section_if_missing,        ('fafcfe36', 'EllenSkin.Tail.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('beb3f207', 'cf37068c'), 'EllenSkin.TailA.MaterialMap.1024')),
    ],
    'cf37068c': [
        (log,                           ('2.0: EllenSkin TailA MaterialMap 1024p Hash',)),
        (add_section_if_missing,        ('fafcfe36', 'EllenSkin.Tail.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('abb51170', '51cc39d5'), 'EllenSkin.TailA.MaterialMap.2048')),
    ],
    ...
    'a22d2c2c': [
        ...
        (add_section_if_missing,        ('89299f56', 'Grace.Hair.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('26bf1588', '48c17612'), 'Grace.HairA.LightMap.1024')),
    ],
    '48c17612': [
    ...
    '7bb81a4f': [
        ...
        (add_section_if_missing,        ('89299f56', 'Grace.Hair.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('e1cb3739', '381930fe'), 'Grace.HairA.MaterialMap.1024')),
    ],
    '381930fe': [
    ...
    '895fa458': [
        ...
        (add_section_if_missing,        (('8b240678', '0f82a13e'), 'Grace.Body.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('59dd8899', '7e2e15b3'), 'Grace.BodyA.LightMap.1024')),
    ],
    '7e2e15b3': [
    ...
    '11041778': [
        ...
        (add_section_if_missing,        ('6324de38', 'Harumasa.Hair.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('a1310b4f', '54cc6a9a'), 'Harumasa.HairA.LightMap.1024')),
    ],
    '54cc6a9a': [
        (log,                           ('2.0: Harumasa HairA LightMap 1024p Hash',)),
        (add_section_if_missing,        ('6324de38', 'Harumasa.Hair.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('d4838b9d', '11041778'), 'Harumasa.HairA.LightMap.2048')),
    ],
    '7217c146': [
    ...
    '72885950': [
        ...
        (add_section_if_missing,        ('aa7ba2dc', 'Harumasa.Legs.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('bdbf66a1', 'b84027c8'), 'Harumasa.LegsA.MaterialMap.1024')),
    ],
    'b84027c8': [
        (log,                           ('2.0: Harumasa LegsA MaterialMap 1024p Hash',)),
        (add_section_if_missing,        ('aa7ba2dc', 'Harumasa.Legs.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('ba8e396b', '72885950'), 'Harumasa.LegsA.MaterialMap.2048')),
    ],
    ...
    'a451ca03': [
        ...
        (add_section_if_missing,        ('242a8d48', 'Koleda.Hair.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('144ab293', '1b33709a'), 'Koleda.HairA.LightMap.1024')),
    ],
    '1b33709a': [
        (log,                           ('2.0: Koleda HairA LightMap 1024p Hash',)),
        (add_section_if_missing,        ('242a8d48', 'Koleda.Hair.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('8042506d', 'a451ca03'), 'Koleda.HairA.LightMap.2048')),
    ],
    'd1aac666': [
    ...
    '7c1bce32': [
        ...
        (add_section_if_missing,        ('3afb3865', 'Koleda.Body.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('db58787e', 'a1087d61'), 'Koleda.BodyA.LightMap.1024')),
    ],
    'a1087d61': [
        (log,                           ('2.0: Koleda BodyA LightMap 1024p Hash',)),
        (add_section_if_missing,        ('3afb3865', 'Koleda.Body.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('78e0f9f5', '7c1bce32'), 'Koleda.BodyA.LightMap.2048')),
    ],
    'b60ace0c': [
        (log,                           ('2.0: Koleda BodyA MaterialMap 2048p Hash',)),
        (add_section_if_missing,        ('3afb3865', 'Koleda.Body.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('02e6cb95', '1c162e9c'), 'Koleda.BodyA.MaterialMap.1024')),
    ],
    '1c162e9c': [
        (log,                           ('2.0: Koleda BodyA MaterialMap 1024p Hash',)),
        (add_section_if_missing,        ('3afb3865', 'Koleda.Body.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('6f34885f', 'b60ace0c'), 'Koleda.BodyA.MaterialMap.2048')),
    ],
    'e71d134f': [
    ...
    '0a99d9d5': [
        ...
        (add_section_if_missing,        ('a0ed04de', 'Lucy.Helmet.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('4227db77', '2243086f'), 'Lucy.HelmetA.MaterialMap.1024')),
    ],
    '2243086f': [
        (log,                           ('2.0: Lucy HelmetA MaterialMap 1024p Hash',)),
        (add_section_if_missing,        ('a0ed04de', 'Lucy.Helmet.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('b3013a33', '0a99d9d5'), 'Lucy.HelmetA.MaterialMap.2048')),
    ],
    'ca5fd23a': [
    ...
    '57b175c5': [
        ...
        (add_section_if_missing,        ('22a1347b', 'Lycaon.Legs.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('3dfdab95', '9bcd5f77'), 'Lycaon.LegsA.LightMap.1024')),
    ],
    '9bcd5f77': [
        (log,                           ('2.0: Lycaon LegsA LightMap 1024p Hash',)),
        (add_section_if_missing,        ('22a1347b', 'Lycaon.Legs.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('072e6786', '57b175c5'), 'Lycaon.LegsA.LightMap.2048')),
    ],
    '4b18f890': [
        (log,                           ('2.0: Lycaon LegsA MaterialMap 2048p Hash',)),
        (add_section_if_missing,        ('22a1347b', 'Lycaon.Legs.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('288e7fbd', 'b4e95c1d'), 'Lycaon.LegsA.MaterialMap.1024')),
    ],
    'b4e95c1d': [
        (log,                           ('2.0: Lycaon LegsA MaterialMap 1024p Hash',)),
        (add_section_if_missing,        ('22a1347b', 'Lycaon.Legs.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('4a4ea6dc' ,'4b18f890'), 'Lycaon.LegsA.MaterialMap.2048')),
    ],
    '72f53876': [
    ...
    '1c0193dc': [
        ...
        (multiply_section_if_missing,   (('f8accad8', '0deeb9d2', '362c205e'), 'Nekomata.HairA.LightMap.1024')),
    ],
    '362c205e': [
        (log,                           ('2.0: Nekomata HairA LightMap 1024p Hash',)),
        (multiply_section_if_missing,   (('548c7f7d', '1c0193dc'), 'Nekomata.HairA.LightMap.2048')),
    ],
    '3f73186f': [
        (log,                           ('2.0: Nekomata HairA MaterialMap 2048p Hash',)),
        (multiply_section_if_missing,   (('0c22352c', '63687775', '378b282c'), 'Nekomata.HairA.MaterialMap.1024')),
    ],
    '378b282c': [
        (log,                           ('2.0: Nekomata HairA MaterialMap 1024p Hash',)),
        (multiply_section_if_missing,   (('4ca5efc6', '3f73186f'), 'Nekomata.HairA.MaterialMap.2048')),
    ],
    '799eb07d': [
    ...
    '25df29e7': [
        ...
        (multiply_section_if_missing,   (('4f3f7df0', '4c09361d'), 'Nekomata.HairB.LightMap.1024')),
    ],
    '4c09361d': [
        (log,                           ('2.0: Nekomata HairB, BodyA, SwordsA LightMap 1024p Hash',)),
        (multiply_section_if_missing,   (('fc53fc6f', '25df29e7'), 'Nekomata.HairB.LightMap.2048')),
    ],
    'b3286755': [
    ...
    '8c9c25d5': [
        ...
        (add_section_if_missing,        ('6847bbbd', 'Nicole.Hair.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('9adc04ed', 'f3c21e41'), 'Nicole.HairA.LightMap.1024')),
    ],
    'f3c21e41': [
        (log,                           ('2.0: Nicole HairA LightMap 1024p Hash',)),
        (add_section_if_missing,        ('6847bbbd', 'Nicole.Hair.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('1dfd9e16', '8c9c25d5'), 'Nicole.HairA.LightMap.2048')),
    ],
    'bffb4a66': [
    ...
    'ed361b8f': [
        ...
        (multiply_section_if_missing,   ('9efd1605', 'PanYinhu.FaceA.Diffuse.1024')),
    ],
    '452a0918': [
        (log,                           ('2.0: PanYinhu FaceA Diffuse 1024p Hash',)),
        (add_section_if_missing,        ('ebb6a59b', 'PanYinhu.Face.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   ('7d9ee001', 'PanYinhu.FaceA.Diffuse.2048')),
    ],
    ...
    '1146c5c3': [
        ...
        (add_section_if_missing,        ('940454ef', 'Piper.Hair.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('92acb4d4','6bd15459'), 'Piper.HairA.LightMap.1024')),
    ],
    '6bd15459': [
        (log,                           ('2.0: Piper HairA LightMap 1024p Hash',)),
        (add_section_if_missing,        ('940454ef', 'Piper.Hair.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('79953d32','1146c5c3'), 'Piper.HairA.LightMap.2048')),
    ],
    'b3034dff': [
    ...
    'a32c39b9': [
        ...
        (add_section_if_missing,        ('585da98b', 'Piper.Body.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('db9c7abf','7a281673'), 'Piper.BodyA.LightMap.1024')),
    ],
    '7a281673': [
        (log,                           ('2.0: Piper BodyA LightMap 1024p Hash',)),
        (add_section_if_missing,        ('585da98b', 'Piper.Body.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('9cc2aaa0','a32c39b9'), 'Piper.BodyA.LightMap.2048')),
    ],
    '7fdee30d': [
    ...
    'a855884d': [
        ...
        (add_section_if_missing,        ('35cf83ad', 'Seth.Hair.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('c01dbf6c', 'ca070fa7'), 'Seth.HairA.LightMap.1024')),
    ],
    'ca070fa7': [
        (log,                           ('2.0: Seth HairA LightMap 1024p Hash',)),
        (add_section_if_missing,        ('35cf83ad', 'Seth.Hair.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('d4de9ec1', 'a855884d'), 'Seth.HairA.LightMap.2048')),
    ],
    '3c256565': [
    ...
    '5b205468': [
        ...
        (add_section_if_missing,        ('00172ec3', 'Seth.Body.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('9436aa83', '57cf813c'), 'Seth.BodyA.LightMap.1024')),
    ],
    '57cf813c': [
        (log,                           ('2.0: Seth BodyA LightMap 1024p Hash',)),
        (add_section_if_missing,        ('00172ec3', 'Seth.Body.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('3d97c2ef', '5b205468'), 'Seth.BodyA.LightMap.2048')),
    ],
    '732d3f81': [
    ...
    '0b059f91': [
        ...
        (add_section_if_missing,        ('217ec790', 'Soldier0.Hair.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('ce3e73be','bb979f59'), 'Soldier0.HairA.MaterialMap.1024')),
    ],
    'bb979f59': [
        (log,                           ('2.0: Soldier0 HairA MaterialMap 1024p Hash',)),
        (add_section_if_missing,        ('217ec790', 'Soldier0.Hair.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('464847b3','0b059f91'), 'Soldier0.HairA.MaterialMap.2048')),
    ],
    ...
    '71993491': [
        ...
        (add_section_if_missing,        ('2fa74e2f', 'Soldier11.Hair.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('baa3c836', '17e75c76'), 'Soldier11.HairA.LightMap.1024')),
    ],
    '17e75c76': [
        (log,                           ('2.0: Soldier11 HairA LightMap 1024p Hash',)),
        (add_section_if_missing,        ('2fa74e2f', 'Soldier11.Hair.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('787659b9', '71993491'), 'Soldier11.HairA.LightMap.2048')),
    ],
    '68d9644a': [
    ...
    '33e8af55': [
        ...
        (add_section_if_missing,        ('e3ee72d9', 'Soldier11.Body.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('ce581269', '744e39e9'), 'Soldier11.BodyA.LightMap.1024')),
    ],
    '744e39e9': [
    ...
    '8ab5b59d': [
        ...
        (add_section_if_missing,        ('e3ee72d9', 'Soldier11.Body.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('874f9f68', '9d09159b'), 'Soldier11.BodyA.MaterialMap.1024')),
    ],
    '9d09159b': [
        (log,                           ('2.0: Soldier11 BodyA MaterialMap 1024p Hash',)),
        (add_section_if_missing,        ('e3ee72d9', 'Soldier11.Body.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('81db8cbe', '8ab5b59d'), 'Soldier11.BodyA.MaterialMap.2048')),
    ],
    'c94bb3d6': [
    ...
    'a70e24a2': [
        ...
        (add_section_if_missing,        ('fe70c7a3', 'Soukaku.Hair.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('7bbb3d02', '5966c5e3'), 'Soukaku.HairA.LightMap.1024')),
    ],
    '5966c5e3': [
        (log,                           ('2.0: Soukaku HairA LightMap 1024p Hash',)),
        (add_section_if_missing,        ('fe70c7a3', 'Soukaku.Hair.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('04654e94', 'a70e24a2'), 'Soukaku.HairA.LightMap.2048')),
    ],
    'd1444c52': [
    ...
    '8d8269f8': [
        ...
        (add_section_if_missing,        ('f6cac296', 'Wise.Hair.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('6fcc4ad4', '33368e12'), 'Wise.HairA.LightMap.1024')),
    ],
    '33368e12': [
        (log,                           ('2.0: Wise HairA, BagA LightMap 1024p Hash',)),
        (add_section_if_missing,        ('f6cac296', 'Wise.Hair.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('1f21c633', '8d8269f8'), 'Wise.HairA.LightMap.2048')),
    ],
    'f1b20f3d': [
        (log,                           ('2.0: Wise HairA, BagA MaterialMap 2048p Hash',)),
        (add_section_if_missing,        ('f6cac296', 'Wise.Hair.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('7c8b0713', 'd9383a15'), 'Wise.HairA.MaterialMap.1024')),
    ],
    'd9383a15': [
        (log,                           ('2.0: Wise HairA, BagA MaterialMap 1024p Hash',)),
        (add_section_if_missing,        ('f6cac296', 'Wise.Hair.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('473f816d', 'f1b20f3d'), 'Wise.HairA.MaterialMap.2048')),
    ],
    '3b4f22ad': [
    ...
    '616200aa': [
        ...
        (add_section_if_missing,        ('f478ee4c', 'Yanagi.Body.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('f60602ec', '3ffcef9e'), 'Yanagi.BodyA.LightMap.1024')),
    ],
    '3ffcef9e': [
        (log,                           ('2.0: Yanagi BodyA LightMap 1024p Hash',)),
        (add_section_if_missing,        ('f478ee4c', 'Yanagi.Body.IB', 'match_priority = 0\n')),
        (multiply_section_if_missing,   (('08933e28', '616200aa'), 'Yanagi.BodyA.LightMap.2048')),
    ],
    'c2ae5d2b': [
